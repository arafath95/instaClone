    ...
    <div className="">
      <div className="post mt-6 bg-white  mx-auto max-w-sm md:max-w-md lg:max-w-[100%]">
        <div className="flex items-center justify-center border-t-2 border-gray-300">
          <div className="">
            <BiSmile className="w-14 h-14 m-4 text-[#262626] " />
          </div>
          {/* search input field  */}

          <input
            className="flex justify-center mr-3  bg-white  mx-auto  w-5/6 h-12 rounded-xl focus:outline-none "
            placeholder=" Add a Comment.. "
          />

          <button disabled className="text-[#23a4fa]">
            Post
          </button>
        </div>
      </div>
