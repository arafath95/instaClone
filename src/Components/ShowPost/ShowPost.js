...
const ShowPost = ({ singlePost }) => {
  ...
  useEffect(() => {
    fetch("user.json")
      ...
      .then((data) => data.post_data?.comments);
  }, []);
  return (
    <div className="">
      <div className="">
        <div className=" mx-auto max-w-sm md:max-w-md lg:max-w-[750px] bg-white shadow-md rounded-xl mb-4 ">
          <div className="flex items-start relative">
            ...
            >
              <div className="">
                {/* post time */}
                <small className="flex gap-1 items-center relative top-8 left-16 text-gray-500 font-semibold"></small>
              </div>
            </div>
            ...
            <BsThreeDots className=" absolute   right-3    top-4" />
          </div>
          <div>
            {/* post des */}
          ...
          <div className="likeCommentShar mb- ">
            <div className="flex justify-between p-2 pb-4">
              ...
              {/* comment */}
              <div className="flex hover:underline cursor-pointer"></div>
            </div>
            ...
            <p className="px-4">
              ...
              <p className="py-5 text-gray-400 ">
                {" "}
                View all {conments.length} Comments
              </p>
